...
export function WatchlistView({
  ...
  if (watchlist.length === 0) {
    return (
      <div className="py-20 text-center px-6 max-w-sm mx-auto">
        ...
        <h3 className="text-base font-bold text-slate-900 mt-4">Watchlist Belum Terisi</h3>
        <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
          Tandai bintang pada saham pilihan di tab Screener untuk memantau harga dan pergerakan hariannya di sini.
        </p>
        <div className="mt-5">
          <Button onClick={onGoToScreener} className="mx-auto bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-xs">
  ...
  return (
    <div className="p-4 space-y-2.5 pb-28 w-full max-w-md mx-auto">
      <div className="flex items-center justify-between pb-1">
        ...
        <span className="text-[11px] text-slate-400 font-medium">Tersimpan di Perangkat</span>
      </div>
